...
<head>
    ...
    @section('seo')
        ...
        <meta property="og:site_name" content="Варвик. Группы товаров" />
        <meta property="og:title" content="Varvik каталог запчастей | Группы товаров."/>
        <meta property="og:description" content="Группы и категории запчастей и автотоваров сайта Варвик. Все товары на сайте для удобства поиска и выбора разнесены на группы. Вы можете заказать обратный звонок и наши сотрудники готовы содействовать вам в выборе и покупке автозапчастей.">
        {{--<title>Varvik поиск и продажа запчастей.| {{$cat->name}}."/></title>--}}
        <meta property="og:url" content="http://varvik.com.ua/category" />
        <meta property="og:image" content="/img/logo.png" />

        <meta name="description" content="Группы и категории запчастей и автотоваров сайта Варвик. Все товары на сайте для удобства поиска и выбора разнесены на группы. Вы можете заказать обратный звонок и наши сотрудники готовы содействовать вам в выборе и покупке автозапчастей. Предоставят грамотную профессиональную консультацию для предстоящей покупке и доставке товара">
        <title>Varvik каталог запчастей | Группы товаров.</title>
    @show
